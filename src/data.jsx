const dataFull = {
  1: {
    ...
    value: "frontend",
    color: "#6BD1FF",
    descripcion: "Todos los videos usados para el Front End",
    videos: {
      12345: {
        id: "12345",
  ...
  2: {
    ...
    value: "backend",
    color: "#FFBA05",
    descripcion: "Todos los videos usados para el Back End",
    videos: {
      8541772: {
        id: "8541992",
        titulo: "¿Qué es JavaScript?",
  ...
  3: {
    ...
    value: "ux/ui",
    color: "#6B5BE2",
    descripcion: "Todos los videos usados para el UX/UI",
    videos: {
      12345: {
        id: "12345",
        titulo: "Como utilizar el Display block, inline, inline-block",
